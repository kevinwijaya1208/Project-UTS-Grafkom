...
// Class Hikotchi = Nathan Erens Anderson / c14210131
public class Hikotchi {
    ...
    public ArrayList<Sphere> objectsAttack = new ArrayList<>();

    public boolean attack;
    Camera camera;
    Projection projection;

    public Hikotchi(Camera camera, Projection projection){
        this.camera = camera;
    ...
    public void init(){
        objectsAttack.add(new Sphere(Arrays.asList(
        ...
        ), new Vector4f(1.0f, 0f, 0f, 1.0f), // ini untuk warna object
                0.0f, 0.5f, 0.5f,
                0.4f, 0.4f, 0.4f, 1
        ));
        objectsAttack.get(0).translateObject(-4.0f, 2.0f, -0.5f);
        objectsAttack.get(0).scaleObject(0.8f,0.8f,0.8f);
        ...
        objectsAttack.get(1).translateObject(-4.0f, 2.0f, -0.5f);
        objectsAttack.get(1).scaleObject(0.8f,0.8f,0.8f);
        ...
        objectsAttack.get(2).translateObject(-4.0f, 2.0f, -0.5f);
        objectsAttack.get(2).scaleObject(0.8f,0.8f,0.8f);
        ...
        objectsAttack.get(3).translateObject(-4.0f, 2.0f, -0.5f);
        objectsAttack.get(3).scaleObject(0.8f,0.8f,0.8f);
        ...
        ), new Vector4f(1.0f, 0f, 1.0f, 1.0f), // ini untuk warna object
                0.0f, 0.5f, 0.5f,
                0.4f, 0.4f, 0.4f, 7
        ));
        ...
        ), new Vector4f(1.0f, 1.0f, 0f, 1.0f), // ini untuk warna object
                0.0f, 0.5f, 0.5f,
                0.4f, 0.1f, 0.4f, 12
        ));
        ...
        ), new Vector4f(0f, 0f, 0f, 1.0f), // ini untuk warna object
                0.0f, 0.5f, 0.5f,
                0.1f, 0.1f, 0.1f, 12
        ));
    ...
    public void loop(){
        ...
        if (attack){
            for (Object object: objectsAttack){
                object.draw(camera, projection);
            }
        }
    }
