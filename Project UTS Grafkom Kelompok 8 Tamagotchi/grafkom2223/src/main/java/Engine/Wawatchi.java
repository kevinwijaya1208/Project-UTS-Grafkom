...
public class Wawatchi {
    ...
    public Wawatchi(Camera camera, Projection projection){
        this.camera = camera;
    ...
    public void init() {
        ...
        objectTorus.add(new Torus(Arrays.asList(
                ...
                0.0f, 0.0f, 0.0f, 0.37f, 0.02f, 0.0f, camera, projection
        ));
        objectTorus.get(0).rotateObject((float) Math.toRadians(82), 1.0f, 0.04f, 0.0f);
        objectTorus.get(0).translateObject(0.0f, -0.2f, 0.f);
        ...
        ), new Vector4f(0.623f, 0.847f, 0.968f, 1.0f), // ini untuk warna object
        ...
        objectsLuar.get(0).translateObject(-0.12f, -0.165f, 0.35f);
        ...
        objectsLuar.get(1).translateObject(0.005f, -0.163f, 0.37f);
        ...
        objectsLuar.get(2).translateObject(0.13f, -0.155f, 0.35f);

        // childnya badan tabung itu badan atas(1) bawah(2) kiri(3) kanan(4), muka(5), torus
    ...
    public void translateObject(float x, float y, float z) {
        ...
        public void gerakMaju () {
            gerakKakiKananKiri();
            objectsSphere.get(0).translateObject(0.0f,0.0f,0.005f);
        }
    ...
    public void loop() {
        ...
        if (toTheMoon) {
            ...
            for (Torus torus : objectTorus) {
                torus.scaleObject(0.997f, 0.997f, 0.999f);
            }
            for (Sphere sphere : objectsLuar) {
                sphere.scaleObject(0.997f, 0.997f, 0.999f);
            }
