...
public class Tamatchi {
    ...
    public void init(){
        ...
        ), new Vector4f(0.913f, 0.066f, 0.56f, 1.0f), // ini untuk warna object segitiganya
                0.0f, 0.0f, 0.0f,
                0.4f, 0.45f, 0.2f, 12
        ));
        ...
        objectsSphere.get(3).translateObject(0.0f, -0.12f, -0.15f);
        ...
        ), new Vector4f(1.0f, 0.713f, 0.756f, 1.0f), // ini untuk warna object segitiganya
                0.1f, 0.3f, 0.0f,
                0.03f, 0.02f, 0.2f, 1
        ));
